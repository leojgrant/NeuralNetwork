...
//    List<double> layers = HelperFunctions.ExtractNumbersFromString(userInput);
...
//    userInput = Console.ReadLine();
//    Console.WriteLine("");
//    List<double> inputs = HelperFunctions.ExtractNumbersFromString(userInput);
...
//    userInput = Console.ReadLine();
//    Console.WriteLine("");
//    List<double> targets = HelperFunctions.ExtractNumbersFromString(userInput);
...
//        userInput = Console.ReadLine();
//        targets = HelperFunctions.ExtractNumbersFromString(userInput);
//        Console.WriteLine("");
//    }
...
//    userInput = Console.ReadLine();
//    double numberOfTrainingCycles = HelperFunctions.ExtractNumbersFromString(userInput)[0];
